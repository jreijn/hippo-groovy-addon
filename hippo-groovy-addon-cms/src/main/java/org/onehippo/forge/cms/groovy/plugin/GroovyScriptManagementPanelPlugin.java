...
import org.onehippo.forge.cms.groovy.plugin.panels.GroovyScriptManagementPanel;
...
public class GroovyScriptManagementPanelPlugin extends GroovyPanelPlugin {
    ...
    public GroovyScriptManagementPanelPlugin(IPluginContext context, IPluginConfig config) {
    ...
    public IModel<String> getTitle() {
        return new ResourceModel("groovy-script-management");
    }

    @Override
    public IModel<String> getHelp() {
        return new ResourceModel("groovy-script-management-title-help");
    }

    @Override
    public PanelPluginBreadCrumbPanel create(final String componentId, final IBreadCrumbModel breadCrumbModel) {
        return new GroovyScriptManagementPanel(componentId, breadCrumbModel);
    }
}
