...
Currently this plugin is not yet located in any public maven repository. Therefor you will need to manually build the
plugin before it can be used within your project.
